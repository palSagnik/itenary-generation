    ...
    <footer className="pt-5">
      <Container>
        <Row>
          ...
          <a target="_blank" href="mailto:xxxxxxxxx@gmail.com" className="d-block" >xxxxxxxxr@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:xxxxxxxxxxx" className="d-block" >99999988888</a>
          </div>
